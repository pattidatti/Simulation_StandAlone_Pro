...
export const CRAFTING_RECIPES: Record<string, any> = {
    ...
    siege_swords: { label: 'Beleiringsvåpen (x10)', icon: '⚔️', input: { iron_ingot: 5, plank: 5, gold: 50 }, outputItemId: 'siege_sword', outputAmount: 10, buildingId: 'great_forge', level: 2, stamina: 40, xp: 30, description: 'En kasse med våpen til garnisonen.', skill: 'CRAFTING' },
    siege_armor: { label: 'Beleiringsrustning (x10)', icon: '🛡️', input: { iron_ingot: 5, cloth: 5, gold: 50 }, outputItemId: 'siege_armor', outputAmount: 10, buildingId: 'great_forge', level: 2, stamina: 40, xp: 30, description: 'En kasse med rustninger til garnisonen.', skill: 'CRAFTING' },
