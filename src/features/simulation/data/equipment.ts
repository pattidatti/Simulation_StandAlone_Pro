...
export const ITEM_TEMPLATES: Record<string, ItemTemplate> = {
    ...
    whetstone: { id: 'whetstone', name: 'Bryne', icon: '🪨', type: 'OFF_HAND', durability: 100, maxDurability: 100, level: 1, description: 'Bruk bryne for å holde verktøy skarpe. Gir +1 i utbytte på de fleste sanke-oppgaver.', stats: { yieldBonus: 1 }, relevantActions: ['CHOP', 'MINE', 'QUARRY', 'WORK', 'GATHER_WOOL'] },
