...
export const INITIAL_RESOURCES: Record<Role, Resources> = {
    KING: {
        ...
        egg: 0, omelette: 0, flax: 0, linen_canvas: 0, tar: 0, fish_raw: 0, fish_cooked: 0,
        silk: 0, spice: 0, cannonball: 20,
        minor_stamina_potion: 0, herbal_balm: 0, focus_brew: 0, strength_tincture: 0, masters_draught: 0, elixir_of_life: 0
    },
    BARON: {
