...
export const TrappingGame: React.FC<TrappingGameProps> = ({ onComplete, speedMultiplier = 1.0, variant = 'water' }) => {
    ...
    return (
        <div className="p-12 text-center min-h-[600px] relative flex flex-col items-center justify-center overflow-hidden"
            style={{
                backgroundImage: variant === 'land' ? 'url("/images/textures/forest_floor.png")' : 'url("/images/minigames/foraging_bg.png")', // TODO: Needs specific trapping BG
                backgroundColor: variant === 'land' ? '#2f3e28' : '#0c4a6e',
                backgroundSize: 'cover'
            }}>
            <div className="absolute inset-0 bg-black/70 z-0" />
            <h2 className="relative z-10 text-4xl font-black text-white mb-12 tracking-tighter uppercase italic">
            ...
            <button onClick={handleCatch} className="relative z-10 w-full max-w-md bg-sky-500 hover:bg-sky-400 text-white py-7 rounded-[2rem] font-black text-2xl shadow-2xl active:scale-95 transition-all uppercase tracking-widest border-b-4 border-sky-700">
