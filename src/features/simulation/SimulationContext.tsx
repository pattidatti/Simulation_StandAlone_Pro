...
type MinigameType = 'WORK' | 'CHOP' | 'CRAFT' | 'MILL' | 'DEFEND' | 'EXPLORE' | 'MINE' | 'QUARRY' | 'PATROL' | 'FORAGE' | 'REFINE' | 'PLANT' | 'HARVEST' | 'SMELT' | 'BAKE' | 'WEAVE' | 'MIX' | 'SAWMILL' | 'GATHER_WOOL' | 'HUNT' | 'TRAVEL_START' | null;
