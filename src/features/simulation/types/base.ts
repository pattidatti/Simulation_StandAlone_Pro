...
export type ResourceType = 'gold' | 'grain' | 'flour' | 'bread' | 'wood' | 'plank' | 'iron_ore' | 'iron_ingot' | 'stone' | 'siege_sword' | 'siege_armor' | 'favor' | 'wool' | 'cloth' | 'honey' | 'meat' | 'glass' | 'manpower' | 'egg' | 'omelette' | 'flax' | 'linen_canvas' | 'tar' | 'fish_raw' | 'fish_cooked' | 'silk' | 'spice' | 'cannonball';
